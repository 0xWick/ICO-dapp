...
export default function Home() {
  ...
  /**
   * getBalanceOfCryptoDev Tokens: checks the balance of Crypto Dev Token's held by adrress
   */
  ...
  /**
   * mingCryptoDevTokens: mints `amount` number of tokens to a given address
   */
